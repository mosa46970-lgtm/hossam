const SKILLS_DATA = [
  { name: 'AutoCAD Civil 3D', level: '99%', className: 'civil3d', width: '99%' },
  ...
  { name: 'BIM Coordination & LOD 400', level: '90%', className: 'bimco', width: '90%' },
    ...
    <section className="skills" id="skills">
      ...
      <div className="skills-grid">
        {SKILLS_DATA.map((skill, index) => (
          <div className={`skill-card ${index === 0 ? 'active' : ''}`} key={skill.name}>
